...
public class ScooterTest extends BaseTest {
    ...
    public ScooterTest(String questionHeader, String questionText) {
        super();
    ...
    public void importantQuestionsTest(){
        ...
        scooterPage.clickQuestionHeaderByText(questionHeader);
        String openedText = scooterPage.getOpenedText();
